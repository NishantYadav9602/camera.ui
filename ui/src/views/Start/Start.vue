    ...
    v-stepper-items
      ...
      v-stepper-content.start-wrapper(step='1')
        v-card.start-content.tw-flex.tw-justify-center.tw-items-center.tw-flex-col(height="320px")
          ...
          .tw-block
            v-img(src="@/assets/img/logo.png" width="42" height="50")
      ...
      v-stepper-content.start-wrapper(step='3')
        v-card.start-content.tw-flex.tw-justify-center.tw-items-center.tw-flex-col(height="320px")
          ...
          .tw-block
            inline-svg(:src="require('../../assets/img/logo.png')" title="camera.ui" aria-label="camera.ui" width="78px" height="84px")
